...
video_name = "videoProva.mp4"
video_path = "C:/Users/Alessandro/Desktop/Research Project/RT_HAI/Videos/VideoProva.mp4"
start_time = None
elapsed_time = None
user_body = {}
        ...
        with holistic as pose:
            while cap.isOpened():
                ...
                if elapsed_time > configuration_time and configuration_isdone == False:
                    input("Press Enter to start the configuration of the body")
